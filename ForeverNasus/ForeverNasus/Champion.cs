...
namespace ForeverAIO
{
    class Champion
    {
        ...
        {
            Game.PrintChat("<font color = \"#ff0000\">Forever AIO</font> by <font color = \"#00FFFF\">BillyGG</font>");
            Game.PrintChat("<font color = \"#87CEEB\">Feel free to donate via Paypal to:</font> <font color = \"#FFFF00\">BillyGDesigns@hotmail.com</font>");

            menu = new Menu(Player.ChampionName, Player.ChampionName, true);

            //Info
            menu.AddSubMenu(new Menu("Info", "Info"));
            menu.SubMenu("Info").AddItem(new MenuItem("Author", "By BillyGG"));
            menu.SubMenu("Info").AddItem(new MenuItem("Paypal", "Donate: BillyGDesigns@hotmail.com"));
            //Target selector
            ...
            //Packet Menu
            menu.AddSubMenu(new Menu("Packet Setting - Not Currently Working", "Packets"));
            ...
            try
            {
                if (Activator.CreateInstance(null, "ForeverAIO.Champions." + Player.ChampionName) != null)
                {
                    Game.PrintChat("<font color = \"#FFB6C1\">Forever " + Player.ChampionName + " Loaded!</font>");
                }
            }
            catch
            {
                Game.PrintChat("ForeverAIO => {0} Not Support !", Player.ChampionName);
            }
        }
